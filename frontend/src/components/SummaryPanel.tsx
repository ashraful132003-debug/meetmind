...
/**
 * Renders the Markdown subset the summary prompt produces (h2, bullets, bold,
 * inline code). Deliberately not a Markdown library: the input is a known shape
 * from our own prompt, and every third-party renderer is a potential XSS hole.
 * Text is written via JSX children, so React escapes it - no dangerouslySetInnerHTML
